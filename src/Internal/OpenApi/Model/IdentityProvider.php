...
class IdentityProvider implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    {
        if (is_null($binding)) {
            array_push($this->openAPINullablesSetToNull, 'binding');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('binding', $nullablesSetToNull, true);
            if ($index !== false) {
     ...
     * Sets logOut
     *
     * @param string|null $logOut logOut
     *
     * @return self
     */
    ...
    {
        if (is_null($logOut)) {
            array_push($this->openAPINullablesSetToNull, 'logOut');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('logOut', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
