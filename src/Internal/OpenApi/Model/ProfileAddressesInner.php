...
/**
 * ProfileAddressesInner Class Doc Comment
 *
 * @category Class
 * @package  LoginRadius\Sdk\Internal\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class ProfileAddressesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Profile_Addresses_inner';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type The type of address (e.g., Home, Work).
     *
     * @return self
     */
     ...
     * Sets operation
     *
     * @param string|null $operation The operation performed on the address.
     *
     * @return self
     */
