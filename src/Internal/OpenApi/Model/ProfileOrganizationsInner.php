...
/**
 * ProfileOrganizationsInner Class Doc Comment
 *
 * @category Class
 * @package  LoginRadius\Sdk\Internal\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class ProfileOrganizationsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Profile_Organizations_inner';
    ...
    */
     ...
     * Sets logoURL
     *
     * @param string|null $logoURL The logo URL of the organization.
     *
     * @return self
     */
