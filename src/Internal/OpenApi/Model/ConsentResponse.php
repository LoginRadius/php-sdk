...
class ConsentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets accessToken
     *
     * @param string|null $accessToken The Access Token string
     *
     * @return self
     */
     ...
     * Sets refreshToken
     *
     * @param string|null $refreshToken The refresh token string
     *
     * @return self
     */
     ...
     * Sets expiresIn
     *
     * @param string|null $expiresIn Expiration time of the Access Token
     *
     * @return self
     */
