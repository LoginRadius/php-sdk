...
/**
 * UserRolePutRequest Class Doc Comment
 *
 * @category Class
 * @package  LoginRadius\Sdk\Internal\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class UserRolePutRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserRolePutRequest';
    ...
    */
     ...
     * Sets roleIds
     *
     * @param string[] $roleIds Unique identifier of the Role.
     *
     * @return self
     */
