...
/**
 * ManageRegisterModelAgeRange Class Doc Comment
 *
 * @category Class
 ...
 */
class ManageRegisterModelAgeRange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManageRegisterModel_AgeRange';
    ...
    */
     ...
     * Sets min
     *
     * @param int|null $min The minimum age in the range.
     *
     * @return self
     */
     ...
     * Sets max
     *
     * @param int|null $max The maximum age in the range.
     *
     * @return self
     */
