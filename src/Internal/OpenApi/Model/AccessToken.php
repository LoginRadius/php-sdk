...
class AccessToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'refreshToken' => 'string',
        'expiresIn' => '\DateTime',
        'sessionToken' => '\LoginRadius\Sdk\Internal\OpenApi\Model\AccessTokenSessionToken'
    ];
    ...
    */
     ...
     * Sets accessToken
     *
     * @param string|null $accessToken The generated Access Token.
     *
     * @return self
     */
     ...
     * Sets refreshToken
     *
     * @param string|null $refreshToken The refresh token associated with the Access Token.
     *
     * @return self
     */
    public function setRefreshToken($refreshToken)
    {
        if (is_null($refreshToken)) {
            ...
            $index = array_search('refreshToken', $nullablesSetToNull, true);
            if ($index !== false) {
     ...
     * Sets expiresIn
     *
     * @param \DateTime|null $expiresIn The expiration time of the Access Token.
     *
     * @return self
     */
     ...
     * Gets sessionToken
     *
     * @return \LoginRadius\Sdk\Internal\OpenApi\Model\AccessTokenSessionToken|null
     */
     ...
     * Sets sessionToken
     *
     * @param \LoginRadius\Sdk\Internal\OpenApi\Model\AccessTokenSessionToken|null $sessionToken sessionToken
     *
     * @return self
     */
