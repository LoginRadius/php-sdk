...
/**
 * ProfilePhoneNumbersInner Class Doc Comment
 *
 * @category Class
 * @package  LoginRadius\Sdk\Internal\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class ProfilePhoneNumbersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Profile_PhoneNumbers_inner';
    ...
    */
     ...
     * Sets phoneType
     *
     * @param string|null $phoneType The type of Phone (e.g., Mobile, Home).
     *
     * @return self
     */
     ...
     * Sets operation
     *
     * @param string|null $operation The operation performed on the Phone number.
     *
     * @return self
     */
