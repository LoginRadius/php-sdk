...
/**
 * OrganizationsConnectionSamlBaseIDPCertificate Class Doc Comment
 *
 * @category Class
 * @description IdP certificate details, including the PEM value and its validity window.
 * @package  LoginRadius\Sdk\Internal\OpenApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class OrganizationsConnectionSamlBaseIDPCertificate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrganizationsConnectionSamlBase_IDPCertificate';
    ...
    */
     ...
     * Sets certificate
     *
     * @param string|null $certificate The Identity Provider's certificate in PEM format.
     *
     * @return self
     */
     ...
     * Sets notAfter
     *
     * @param \DateTime|null $notAfter The expiration date of the IdP certificate.
     *
     * @return self
     */
     ...
     * Sets notBefore
     *
     * @param \DateTime|null $notBefore The start date of the IdP certificate validity.
     *
     * @return self
     */
