...
class GenerateTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets token
     *
     * @param string|null $token The generated token for the specific request.
     *
     * @return self
     */
     ...
     * Sets expiresIn
     *
     * @param \DateTime|null $expiresIn The expiration date and time of the token.
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $identityProviders The identity providers associated with the specified token, it will display a list of identity providers from where the User is already authenticated.
     *
     * @return self
     */
    public function setIdentityProviders($identityProviders)
    {
        if (is_null($identityProviders)) {
            ...
            $index = array_search('identityProviders', $nullablesSetToNull, true);
            if ($index !== false) {
