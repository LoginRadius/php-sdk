...
/**
 * TwoFAAuthBySecQuesAuthModelSecurityquestionanswerInner Class Doc Comment
 *
 * @category Class
 * @package  LoginRadius\Sdk\Internal\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class TwoFAAuthBySecQuesAuthModelSecurityquestionanswerInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TwoFAAuthBySecQuesAuthModel_securityquestionanswer_inner';
    ...
    */
     ...
     * Sets questionId
     *
     * @param string $questionId ID of the security question (required, not blank)
     *
     * @return self
     */
     ...
     * Sets answer
     *
     * @param string $answer Answer to the security question (required, not blank)
     *
     * @return self
     */
