...
/**
 * CustomOAuth2DeleteModel Class Doc Comment
 *
 * @category Class
 * @package  LoginRadius\Sdk\Internal\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class CustomOAuth2DeleteModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomOAuth2DeleteModel';
    ...
    */
     ...
     * Sets providerName
     *
     * @param string $providerName The name of the OAuth2 provider to be deleted.
     *
     * @return self
     */
