...
/**
 * IsRegistered Class Doc Comment
 *
 * @category Class
 * @package  LoginRadius\Sdk\Internal\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class IsRegistered implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IsRegistered';
    ...
    */
     ...
     * Sets isRegistered
     *
     * @param bool|null $isRegistered Indicates if the Push Notification device is registered
     *
     * @return self
     */
