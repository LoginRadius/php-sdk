...
/**
 * ProfileRequestModelSubscription Class Doc Comment
 *
 * @category Class
 * @package  LoginRadius\Sdk\Internal\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class ProfileRequestModelSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProfileRequestModel_Subscription';
    ...
    */
     ...
     * Sets privateRepos
     *
     * @param string|null $privateRepos privateRepos
     *
     * @return self
     */
    public function setPrivateRepos($privateRepos)
    {
        if (is_null($privateRepos)) {
            throw new \InvalidArgumentException('non-nullable privateRepos cannot be null');
        }
