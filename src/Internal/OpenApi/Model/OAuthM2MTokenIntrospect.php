...
/**
 * OAuthM2MTokenIntrospect Class Doc Comment
 *
 * @category Class
 ...
 */
class OAuthM2MTokenIntrospect implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OAuthM2MTokenIntrospect';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('tokenTypeHint', $data ?? [], 'access_token');
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tokenTypeHint'] === null) {
            $invalidProperties[] = "'tokenTypeHint' can't be null";
        }
     ...
     * Sets tokenTypeHint
     *
     * @param string $tokenTypeHint tokenTypeHint
     *
     * @return self
     */
