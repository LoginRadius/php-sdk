...
/**
 * OAuthDeviceCodeFlow Class Doc Comment
 *
 * @category Class
 ...
 */
class OAuthDeviceCodeFlow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OAuthDeviceCodeFlow';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('grantType', $data ?? [], 'urn:ietf:params:oauth:grant-type:device_code');
