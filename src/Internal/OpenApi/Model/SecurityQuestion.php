 ...
 */
class SecurityQuestion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets questionId
     *
     * @param string|null $questionId Unique identifier of the security question.
     *
     * @return self
     */
     ...
     * Sets question
     *
     * @param string|null $question The security question text.
     *
     * @return self
     */
