 ...
 */
class RaasOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RaasOptions';
    ...
    */
     ...
     * Sets text
     *
     * @param string|null $text The text of the option.
     *
     * @return self
     */
