...
class Permissions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier for the Permission
     *
     * @return self
     */
     ...
     * Sets resourceId
     *
     * @param string|null $resourceId The identifier of the Auth Server API resource this permission belongs to. Only present if the permission is associated with a resource.
     *
     * @return self
     */
     ...
     * Sets createdDate
     *
     * @param \DateTime|null $createdDate The date the Permission was created
     *
     * @return self
     */
     ...
     * Sets modifiedDate
     *
     * @param \DateTime|null $modifiedDate The date the Permission was last modified
     *
     * @return self
     */
