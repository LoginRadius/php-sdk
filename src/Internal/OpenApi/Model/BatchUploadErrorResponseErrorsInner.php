...
/**
 * BatchUploadErrorResponseErrorsInner Class Doc Comment
 *
 * @category Class
 * @package  LoginRadius\Sdk\Internal\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class BatchUploadErrorResponseErrorsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BatchUploadErrorResponse_Errors_inner';
    ...
    */
     ...
     * Sets fieldName
     *
     * @param string $fieldName Identifier for the record that caused the error.
     *
     * @return self
     */
     ...
     * Sets errorMessage
     *
     * @param string $errorMessage Description of the specific error related to the field.
     *
     * @return self
     */
