...
/**
 * ConsentFormEvent Class Doc Comment
 *
 * @category Class
 * @package  LoginRadius\Sdk\Internal\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class ConsentFormEvent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConsentFormEvent';
    ...
    */
     ...
     * Sets isCustom
     *
     * @param bool|null $isCustom Indicates if the event is custom.
     *
     * @return self
     */
