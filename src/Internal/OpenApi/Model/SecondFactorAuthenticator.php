...
/**
 * SecondFactorAuthenticator Class Doc Comment
 *
 * @category Class
 * @package  LoginRadius\Sdk\Internal\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class SecondFactorAuthenticator implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecondFactorAuthenticator';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('secondFactor', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['secondFactor'];
    }

    /**
     * Sets secondFactor
     *
     * @param string|null $secondFactor secondFactor
     *
     * @return self
     */
    public function setSecondFactor($secondFactor)
    {
        if (is_null($secondFactor)) {
            array_push($this->openAPINullablesSetToNull, 'secondFactor');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('secondFactor', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['secondFactor'] = $secondFactor;
