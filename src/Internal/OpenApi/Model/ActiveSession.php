...
/**
 * ActiveSession Class Doc Comment
 *
 * @category Class
 * @package  LoginRadius\Sdk\Internal\OpenApi
 * @author   OpenAPI Generator team
 ...
 */
class ActiveSession implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ActiveSession';
    ...
    */
     ...
     * Sets loginDate
     *
     * @param \DateTime|null $loginDate loginDate
     *
     * @return self
     */
    public function setLoginDate($loginDate)
    {
        if (is_null($loginDate)) {
            throw new \InvalidArgumentException('non-nullable loginDate cannot be null');
        }
