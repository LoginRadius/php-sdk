...
/**
 * AddPhoneModel Class Doc Comment
 *
 * @category Class
 ...
 */
class AddPhoneModel implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddPhoneModel';
    ...
    */
     ...
     * Sets phone
     *
     * @param string $phone Phone number to add to the User's Account.
     *
     * @return self
     */
