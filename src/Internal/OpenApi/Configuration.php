...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.loginradius.com';
    ...
    {
        $report  = 'PHP SDK (LoginRadius\Sdk\Internal\OpenApi) Debug Report:' . PHP_EOL;
    ...
    */
     ...
     */
    protected $loginRadiusServerVariables = [];

    /**
     * @param array<string, string> $variables
     * @return $this
     */
    public function setLoginRadiusServerVariables(array $variables): self
    {
        $this->loginRadiusServerVariables = $variables;
        return $this;
    }
     ...
     */
    public function getLoginRadiusServerVariables(): array
    {
        return $this->loginRadiusServerVariables;
    }

    /**
     * An explicit base URL, set by the facade when the caller configured one.
     * A pinned operation's host-settings/template resolution is bypassed
    ...
    public function setLoginRadiusBaseUrlOverride(?string $baseUrl): self
    {
        $this->loginRadiusBaseUrlOverride = $baseUrl;
        return $this;
    }

    public function getLoginRadiusBaseUrlOverride(): ?string
    {
        return $this->loginRadiusBaseUrlOverride;
    }
}
