...
This API is used to update the information of existing accounts in your Cloud Storage. See our [Advanced API Usage section](https://www.loginradius.com/docs/api/v2/customer-identity-api/advanced-api-usage) for more capabilities.
...
**Supported Providers:** Facebook, LinkedIn, Twitter
...
**Note:** Contact LoginRadius support team to enable this API.

**Supported Providers:** Facebook, Google, Linkedin, Twitter, Yahoo
