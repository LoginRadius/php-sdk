...
//If you have Custom API Domain then define 'API_DOMAIN' and 'API_CONFIG_DOMAIN' and replaced it with your custom API domain,
//otherwise no need to define these option in configuration.
//define('API_DOMAIN', 'https://api.example.com'); 
//define('API_CONFIG_DOMAIN', 'https://config.example.com');
