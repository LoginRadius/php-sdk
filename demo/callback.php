<?php include_once('LoginRadiusSDK.php');?>
<html>
<head>
...
if(isset($_REQUEST['token']) && !empty($_REQUEST['token'])){
	...
	$lraccesstoken = $loginradius->loginradius_fetch_access_token(LR_SECRETKEY);
		...
		//User Post Status
		 if(isset($post_status) && $post_status == true){?>
			<div id="view17" style=" margin: 0 auto;width: 350px;">
				...
				<label for="title" class="faclable">Title :</label><input type="text" id="title" value="" class="factextbox"><br />
                                <?php if(!in_array($UserProfileData->Provider, array('twitter'))){?>
                                    ...
                                    <label for="imageurl" class="faclable">Image URL :</label><input type="text" id="imageurl" value="" class="factextbox"><br />
                                <?php }?>
				<label for="status" class="faclable">Message :</label><textarea id="status" class="facetextarea"></textarea><br />
                                <?php if(!in_array($UserProfileData->Provider, array('twitter'))){?>
                                    <label for="description" class="faclable">Description :</label><textarea id="description"  class="facetextarea"></textarea><br />
                                <?php }?>
		 ...
		 if(isset($sendmessage) && $sendmessage == true){?>
			<div id="view18" style=" margin: 0 auto;width: 350px;">
				...
				<br />
				<?php ?>
				<label for="sendsub" class="faclable">Subject :</label><input type="text" id="sendsub" value="" class="factextbox"><br />
